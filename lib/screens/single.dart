...
class _SingleDetailState extends State<SingleDetail> {
  ...
  void getFavourite() async {
    bool isFav = await DatabaseHelper.instance.isFavourite(data['id']);
    setState(() {
      fav = isFav;
    });
  }
                    ...
                    child: SafeArea(
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          if (fav) {
                            ...
                            int i = await DatabaseHelper.instance.insert({
                              ...
                              DatabaseHelper.movieName: data['original_title'],
                        ...
                        child: Icon(
                          Icons.favorite,
                          size: 25.0,
                          color: fav ? Colors.red[300] : Colors.grey[100],
                        ),
                      ),
                    ),
                  ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '\$' + (data['budget'] / 1000000).toString() + 'M',
                            style: TextStyle(
